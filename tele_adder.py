...
wt = (
    '''
 _____  ______     ____  ______  ___       ___  _____  ______  
(  __ \(   __ \   / __ \(_   _ \(  (       )  )/ ___/ (_   _ \ 
 ) )_) )) (__) ) / /  \ \ ) (_) )\  \  _  /  /( (__     ) (_) )
(  ___/(    __/ ( ()  () )\   _/  \  \/ \/  /  ) __)    \   _/ 
 ) )    ) \ \  _( ()  () )/  _ \   )   _   (  ( (       /  _ \ 
( (    ( ( \ \_))\ \__/ /_) (_) )  \  ( )  /   \ \___  _) (_) )
/__\    )_) \__/  \____/(______/    \_/ \_/     \____\(______/ 
                                                               


            version : 1.0

github.com/bdarvind [[re]][DOnt forget to leave a star]
    '''
)
COLORS = {
    "re": "\u001b[31;1m",
...
async def main():
    ...
    async def getmem():
        ...
        print(ye+'[+] Choose your channel where you want to Add members.')
        a=0
        for i in channel:
        ...
        for user in users:
            if count%5000 == 0:
                ...
                print('')
                print('')
                print(ye+"please wait for 30 seconds...")
                time.sleep(30)
            elif count >= 4999:
            ...
            if user['uid'] in my_participants_id:
                ...
                try:
                    ...
                    print(re+"User is in too much channels. Skipping.")
    ...
    for i in channel:
        print(gr+'['+str(a)+']', i.title)
        a += 1
    op = input(ye+'Enter a number to scrap members (or press ENTER to skip): ')
    if op == '':
    ...
    opt = int(op)
    print('')
    print(ye+'[+] Fetching Members please wait...')
    time.sleep(1)
